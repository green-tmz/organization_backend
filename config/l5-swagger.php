    ...
    'documentations' => [
        ...
        'auth' => [
            ...
            'paths' => [
                ...
                */
                'annotations' => [
                    base_path('app') . '/Modules/Api/Auth/Controllers',
                ],
            ],
        ],
        'building' => [
            ...
            'routes' => [
                 ...
                 * Route for accessing api documentation interface
                */
                'api' => 'api-docs/building',
                'docs' => 'api-docs/building',
                'asset' => '/building/asset',
                'oauth2_callback' => '/building/callback',
            ],
            'paths' => [
                /*
                 * Edit to include full URL in ui for assets
                */
                 ...
                 * File name of the generated json documentation file
                */
                'docs_json' => 'building.json',

                /*
                 * File name of the generated YAML documentation file
                */
                'docs_yaml' => 'building.yaml',
                ...
                */
                'annotations' => [
                    base_path('app') . '/Modules/Api/Building/Controllers',
                ],
            ],
        ],
    ],
